...
export default function HomePage() {
  ...
  }, [sortBy, selectedTag, debouncedSearch, setPhotos]);
        ...
        <div className="flex justify-center mb-8">
          <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as any)}>
            <TabsList className="bg-gray-100 rounded-2xl p-1">
              <TabsTrigger value="feed" className="rounded-xl px-6">
                <Sparkles className="w-4 h-4 mr-2" />
                Galeria
              </TabsTrigger>
              <TabsTrigger value="map" className="rounded-xl px-6">
                <MapIcon className="w-4 h-4 mr-2" />
                Mapa
              </TabsTrigger>
              <TabsTrigger value="battle" className="rounded-xl px-6">
